...
String in = JOptionPane.showInputDialog("gimme a state of matter");
		// 5. Iterate through the array and find what the user entered.
		// Hint: .name() or .toString
for (int i = 0; i < som.length; i++) {
	if(in.equals(som[i].toString())) {
...
Random r = new Random();
StatesOfMatter som2 = som[r.nextInt()];
		// 11. Print outs both of its temperatures.
		System.out.println("C: " + som2.getCT() + " | F: " + som2.ctf(som2.getCT()));
